...
fn add_host(map: &&LinkedHashMap<yaml_rust::Yaml, yaml_rust::Yaml>, hosts: &mut Hosts) {
...
fn del_host(map: &&LinkedHashMap<yaml_rust::Yaml, yaml_rust::Yaml>, hosts: &mut Hosts) {
